...
Color_t GetSignalColor(int i){
   Color_t colours[] = {9, 8, 7, 6, 5, 4, 3, 2, 40, 41};
   return colours[i];
}
void ATLAS_LABEL(Double_t x,Double_t y,Color_t color) 
{
  TLatex l; //l.SetTextAlign(12); l.SetTextSize(tsize); 
  l.SetTextAlign(32); // see page 130 in the user guide
...
// void myText(Double_t x,Double_t y,Color_t color,char *text, int align) {
// 
//   //Double_t tsize=0.05;
//   TLatex l; 
...
void myText(Double_t x,Double_t y,Color_t color,TString text, Double_t tsize) {
...
void myMarkerText(Double_t x,Double_t y,Int_t color,Int_t mstyle,TString text,Float_t msize, Float_t tsize) 
{
  // Double_t tsize=0.06;
  
  // TMarker *marker = new TMarker(x-(0.4*tsize),y,8);
   TMarker *marker = new TMarker(x+(0.9*tsize),y,8);
